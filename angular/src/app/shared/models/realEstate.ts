import { INumeric, IRegionCity } from '../../start/models/start-site.models';
import { IGroup } from '../../start/models/start-site.models';
import { HttpClient } from '@angular/common/http';

export class RealEstate {}

export const citiesGroups: IGroup[] = [
	{
		whole: 'dolnośląskie',
		parts: [],
	},
...
export const districtGroups: IGroup[] = [
	{
		whole: 'Warszawa',
		parts: [
			'Bemowo',
...
export const areaFroms: INumeric[] = [
...
export const priceMaxs: INumeric[] = [
...
export const numberOfRooms: INumeric[] = [
	{ value: 1, viewValue: '1' },
	{ value: 2, viewValue: '2' },
	{ value: 3, viewValue: '3' },
	{ value: 4, viewValue: '4' },
...
export const distances: INumeric[] = [
...
export const numberOfFloors: INumeric[] = [
	{ value: 1, viewValue: '1' },
	{ value: 2, viewValue: '2' },
	{ value: 3, viewValue: '3' },
	{ value: 4, viewValue: '4' },
...
export const yearOfBuilds: string[] = [
	'do 1950',
	'od 1950 do 1989',
	'od 1990 do 2010',
	'od 2010',
];
export const properties: string[] = ['Dom', 'Kawalerka', 'Mieszkanie', 'Pokój'];
export const equipment: string[] = ['Winda', 'Pralka', 'Zmywarka'];

export function readCitiesForRegions(
	http: HttpClient,
