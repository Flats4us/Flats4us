...
namespace Flats4us.Entities
{
    public class Flat : Property //not  abstract
    {
        ...
        protected void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Flat { Id = 1, Address = "ul. Wiejska 1, Warszawa", Surface = 70, MaxInhabitants = 2, NumberOfRooms = 1 },
            new Flat { Id = 2, Address = "ul. Wrocławska 12, Kraków", Surface = 120, MaxInhabitants = 4, NumberOfRooms = 1 },
