...
namespace Flats4us.Controllers
{
    ...
    public class GroupChatController : ControllerBase
    {
        ...
        [Authorize]
        [SwaggerOperation(
            Summary = "Adds user from parameter to the given group.",
            Description = "Requires us to be part of the group"
        )]
        ...
        [Authorize]
        [SwaggerOperation(
            Summary = "Fetches users of a group."
        )]
        ...
        [Authorize]
        [SwaggerOperation(
            Summary = "Fetches messages of the group."
        )]
        ...
        [Authorize]
        [SwaggerOperation(
            Summary = "Updates name of a group."
        )]
        ...
        [SwaggerOperation(
            Summary = "Fetches group chats of user."
        )]
